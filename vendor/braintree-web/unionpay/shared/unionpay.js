...
UnionPay.prototype.fetchCapabilities = function (options) {
  ...
  if (cardNumber && hostedFields) {
    ...
    try {
      hostedFieldsBusChannel = hostedFields._getBusChannel();
    } catch (err) {
    ...
    return new Promise(function (resolve, reject) {
      self._initializeHostedFields(function () {
        self._bus.emit(events.HOSTED_FIELDS_FETCH_CAPABILITIES, {channel: hostedFieldsBusChannel}, function (response) {
          if (response.err) {
...
UnionPay.prototype.enroll = function (options) {
  ...
  var hostedFields = options.hostedFields;
  var data, hostedFieldsBusChannel;
  ...
  if (hostedFields) {
    ...
    return new Promise(function (resolve, reject) {
      self._initializeHostedFields(function () {
        self._bus.emit(events.HOSTED_FIELDS_ENROLL, {channel: hostedFieldsBusChannel, mobile: mobile}, function (response) {
          if (response.err) {
            reject(new BraintreeError(response.err));
...
UnionPay.prototype.tokenize = function (options) {
  ...
  if (card && hostedFields) {
    ...
    return new Promise(function (resolve, reject) {
      self._initializeHostedFields(function () {
        self._bus.emit(events.HOSTED_FIELDS_TOKENIZE, assign({}, options, {channel: hostedFieldsBusChannel}), function (response) {
          if (response.err) {
            reject(new BraintreeError(response.err));
